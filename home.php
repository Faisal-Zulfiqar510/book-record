    ...
    <form>
        ...
        <div class="form-group row ">
            ...
            <div class="col-lg-4 col-md-6 col-sm-7">
                <input type="text" name="bookName" id="bookName" class="form-control" placeholder="Enter the book name"
                       required>
            </div>
        </div>
        <div class="form-group row ">
        ...
        <div class="form-group row ">
            ...
            <div class="col-lg-4 col-md-6 col-sm-7">
                <input type="file" name="image" id="image" size="" style="background: transparent; border: none"
                       accept="image/*" onchange="isSelected()" class="form-control" required>
                <div id="imgSelect"></div>
            </div>
        </div>
        <div class="btn-toolbar row">
            <button class="btn btn-outline-light offset-5 " type="submit" id="btnSubmit"
                    formaction="DDL-DML/insert-data.php" formmethod="post" formenctype="multipart/form-data">Submit
            </button>
            <button class="btn btn-outline-light text-light offset-5" id="btnUpdate" type="submit" name="update"
                    style="display: none" formaction="DDL-DML/update-data.php" formmethod="post"
                    formenctype="multipart/form-data">Update
            </button>
